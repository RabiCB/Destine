          ...
          {hoteldata.photos?.[0] && (
            <div>
              <img
                ...
                src={`https://airbnbclone-3off.onrender.com/photos/${hoteldata.photos[0]}`}
              />
            </div>
          )}
            ...
            {hoteldata.photos?.[1] && (
              <div>
                <img
                  ...
                  src={`https://airbnbclone-3off.onrender.com/photos/${hoteldata.photos[1]}`}
                />
              </div>
            )}
            {hoteldata.photos?.[2] && (
              <div>
                <img
                  ...
                  src={`https://airbnbclone-3off.onrender.com/photos/{hoteldata.photos[2]}`}
                />
              </div>
            )}
          </div>
